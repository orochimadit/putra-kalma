        ...
        <div class="content-wrapper">
            ...
            <div class="form-layout">
                <div class="row">
                    ...
                    <form action="{{route('lots.store')}}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
                        <div class="col-md-6 form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Enter Blok" name="blok">
                                </div>
                        ...
                        <div class="col-md-6 form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-md-5">
                                    ...
                                    <input type="text" name="price" placeholder="" class="form-control autonumber" data-a-sep="." data-a-dec=",">
                                </div>
                                @error('surface_area') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
