    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="btn-group pull-right m-t-15">
          ...
          <a href="{{route('staff.create')}}" class="btn btn-default waves-effect waves-light"><span class="m-l-5"><i class="fa fa-plus"></i></span> Tambah</a>
        ...
        <table id="datatable" class="table table-striped table-bordered datatable">
          ...
          @foreach($users as $value)
            <tr>
                ...
                <td>
                  <a id="edit-data" name="ubah" href="{{route('staff.edit',$value->id)}}"  class="table-action-btn"><i class="md md-edit"></i></a>
